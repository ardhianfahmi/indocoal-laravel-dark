...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h2>Supplying Across the World</h2>
      <h1>The leading supplier of charcoal product from Indonesia</h1>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-6">
            <form role="form" method="post" action="{{ route('sendmail') }}" enctype="multipart/form-data" class="php-email-form">
              @csrf
              <div class="row">
              ...
              <div class="form-group mt-3">
                <textarea class="form-control" type="textarea" name="message" rows="5" placeholder="Message" required></textarea>
              </div>
              <div class="my-3">
